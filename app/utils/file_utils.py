...
class FileHandler:
    ...
    def __init__(self):
        ...
        """
        self.supported_file_types = ['txt', 'docx', 'mp3', 'wav', 'm4a', 'mp4']
    ...
    def upload_file(self) -> Optional[str]:
        ...
        try:
            uploaded_file = st.file_uploader(
                ...
                help="Upload a .txt, .docx, .mp3, .wav,  .m4a or .mp4 file containing meeting transcript"
            )
    ...
    def read_file_content(self, uploaded_file) -> str:
        ...
        try:
            ...
            if uploaded_file.type == "text/plain":
                ...
                logger.info("Delegating audio file to audio_handler")
